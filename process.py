...
# 读取 csv（你可以改为你的路径）
df = pd.read_csv("/nas2/home/yuhao/code/xvr/eval_results_new/deepfluoro/eval_results.csv")
...
for model_name, model_dict in result.items():
    pkl_name = f"/nas2/home/yuhao/code/xvr/eval_results_new/deepfluoro/xvr_deepfluoro_{model_name}_metrics.pkl"
