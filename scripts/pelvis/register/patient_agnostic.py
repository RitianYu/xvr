...
def main(subject_id):
    ...
    model = "/nas2/home/yuhao/code/xvr/models/pelvis/patient_agnostic/model.pth"
    ...
    xvr register model \
        {dir}/data/deepfluoro/subject{subject_id:02d}/xrays \
        -v {dir}/data/deepfluoro/subject{subject_id:02d}/volume.nii.gz \
        -m {dir}/data/deepfluoro/subject{subject_id:02d}/mask.nii.gz \
        -c {model} \
        -o {dir}/results/deepfluoro/register/patient_agnostic/subject{subject_id:02d} \
        --warp {dir}/data/deepfluoro/subject{subject_id:02d}/warp.mat \
        --crop 100 \
        --linearize \
        --labels 1,2,3,4,7 \
        --scales 24,12,6 \
